...
const handleFilterFormSubmit = async (e) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setLoading(true);
    const endpoint = `${BASE_URL}/api/category/category/add`;
    let em = [];
  ...
  const deleteItem = async () => {
    setLoading(true);
    const endpoint = `${BASE_URL}/api/category/category/${deletedItemId}`;
    let em = [];
    try {
      const data = {
        id: deletedItemId,
    ...
    <>
      ...
      <Container>
        <Box className="breadcrumb">
          <Breadcrumb routeSegments={[{ name: 'Categories', path: '/master/categories ' },
          { name: 'Form' }]} />
        </Box>
        {
                  ...
                  .map((item, index) => (
                    <TableRow key={index}>
                      ...
                      <TableCell align="right">
                        ...
                        <CategoriesEdit editedItem={editedItem} handleClose={handleClose} open={open} />
