...
function City() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        setLoading(true);
        const endpoint = `${BASE_URL}/api/city/city/add`;
        let em = [];
    ...
    const deleteItem = async () => {
        setLoading(true);
        const endpoint = `${BASE_URL}/api/city/city/${deletedItemId}`;
        let em = [];
        try {
            const data = {
                id: deletedItemId,
        ...
        <>
            ...
            <Container>
                <Box className="breadcrumb">
                    <Breadcrumb routeSegments={[{ name: 'City', path: '/master/city ' },
                    { name: 'Form' }]} />
                </Box>
                {
                                ...
                                {tableData?.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
                                    .map((item, index) => (
                                        <TableRow key={index}>
                                            ...
                                            <TableCell align="center">{item.state_id}</TableCell>
                                            ...
                                            <TableCell align="right">
                                                ...
                                                <CityEdit editedItem={editedItem} handleClose={handleClose} open={open} />
