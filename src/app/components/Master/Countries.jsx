...
function Countries() {
  ...
  const handleFilterFormSubmit = async (e) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        setLoading(true);
        const endpoint = `${BASE_URL}/api/country/country/add`;
        let em = [];
    ...
    const deleteItem = async () => {
        setLoading(true);
        const endpoint = `${BASE_URL}/api/country/country/${deletedItemId}`;
        let em = [];
        try {
            const data = {
                id: deletedItemId,
        ...
        <>
            ...
            <Container>
                <Box className="breadcrumb">
                    <Breadcrumb routeSegments={[{ name: 'Countries', path: '/master/Countries ' },
                    { name: 'Form' }]} />
                </Box>
                {
                                    ...
                                    .map((item, index) => (
                                        <TableRow key={index}>
                                            ...
                                            <TableCell align="right">
                                                ...
                                                <CountriesEdit editedItem={editedItem} handleClose={handleClose} open={open} />
