...
function DocumentCategoriesEdit({ handleClose, open, editedItem }) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setLoading(true);
    const endpoint = `${BASE_URL}/api/document_category/document_category/update`;
    let em = [];
...
export default DocumentCategoriesEdit;
